    ...
    public class InMemorySystemPromptService : ISystemPromptService
    {
        readonly Dictionary<string, string> _prompts = new Dictionary<string, string>()
        {
            { "Assistant.Default", @"
                ...
                guide, guide category, user and sales order (salesOrder) information provided in JSON format below.

                Instructions:
                - Only answer questions related to the information provided below,
                - Don't reference any guide, user, or salesOrder data not provided below.
