...
namespace VectorSearchAiAssistant.Service.Models.ConfigurationOptions
{
    public record CosmosDbSettings
    {
        ...
        public required string MetricsContainer { get; init; }

        public required string CompletionContainer { get; init; }
        
        public bool EnableTracing { get; init; }

        public int MaxMessagesPerPage { get; init; }

        public bool IsPKHierarchical { get; init;}

        public string ApplicationPreferredRegions { get; init; }
